...
local Window = OrionLib:MakeWindow({Name = "Dragon Hub", HidePremium = false, IntroText = "! Orbit", SaveConfig = true, ConfigFolder = "ConfigSetting"})
...
W:AddLabel("⏳ Wait Update Farm Level, Race Draco, Anti Ban Farm Mastery Gun...")

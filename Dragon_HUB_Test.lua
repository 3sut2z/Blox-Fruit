...
if not isfolder("DraSave") then
makefolder("DraSave")
end
if not isfolder("DraSave/Blox Fruits/") then
makefolder("DraSave/Blox Fruits/")
end
if not isfile("DraSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
writefile("DraSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
else
  local Decode = game:GetService("HttpService"):JSONDecode(readfile("DraSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
writefile("DraSave/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
end
else
  return warn("Status : Undetected Executor")
end
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/3sut2z/Dragon-HUB/main/library",true))()
